...
GO
PRINT N'Création de [dbo].[CK_user_birthdate]...';


GO
ALTER TABLE [dbo].[User] WITH NOCHECK
    ADD CONSTRAINT [CK_user_birthdate] CHECK (datediff(year,[birthdate],getdate())>(13) AND datediff(year,[birthDate],getdate())<(100));
...
GO
ALTER TABLE [dbo].[User] WITH CHECK CHECK CONSTRAINT [CK_user_birthdate];
