CREATE VIEW dbo.V_ReadingStatus
AS
SELECT        dbo.UserBook.idBook, dbo.UserBook.idUser, dbo.Book.title, dbo.[User].login, 
...
GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 1, @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'V_ReadingStatus';
